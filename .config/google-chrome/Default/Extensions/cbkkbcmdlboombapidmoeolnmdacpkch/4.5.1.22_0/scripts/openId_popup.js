...
(function () // self invoking function, keep vars out of the global namespace
{
	...
	{
		var darkCover = window.document.getElementById(RDPHelper.popupManager.constants['darkCover']);
		if (!darkCover)
		{
			darkCover = window.document.createElement('div');
			darkCover['id'] = RDPHelper.popupManager.constants['darkCover'];
			darkCover.setAttribute('style', RDPHelper.popupManager.constants['darkCoverStyle']);
	...
	popupManager.createPopupOpener = (function (openidParams)
	{
		...
		var urlToOpen_ = ('urlToOpen' in openidParams) ? openidParams.urlToOpen : null;
        var date_ = new Date();
		...
		var buildUrlToOpen_ = function ()
		{
            ...
            //var tempUrl = "https://gauth.fusionlabs.net/Logout/license_logout2.aspx?ru=auth";
            //var tempUrl = "https://gauth.fusionlabs.net/default.aspx?auth=1";
            //var tempUrl = "http://www.google.com/accounts/Logout";
            //var tempUrl = "https://gauth.fusionlabs.net/default.aspx";
            //var tempUrl = "https://gauth.fusionlabs.net/Logout/sign_in.aspx?si=" + sessionId;
            var tempUrl = urlToOpen_;
		...
		{
//            if ((null !== popupWindow_) && (null !== popupWindow_.document))
//			{
//			    var email_label = popupWindow_.document.getElementById('email_label');
//                
//                if ((null !== email_label))
//			    {    
...
//            var vars = {};
//            var parts = popupWindow_.location.href.replace(/[?&]+([^=&]+)=([^&]*)/gi, function(m,key,value) {
//                vars[key] = value;
//            });
	...
	{
		e.detail.prototype.popupManager = popupManager;
	});
